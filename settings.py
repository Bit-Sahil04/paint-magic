...
display_grid = True     # displays a grid of tilesize x tilesize
...
lerp_speed = 0.1        # How fast should pieces assemble together. 0.01 = 1% of the distance covered per frame
...
default_background_color = (30, 30, 30)   # Default canvas background color
